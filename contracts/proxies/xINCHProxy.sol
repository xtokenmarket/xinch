...
contract xINCHProxy {
    ...
    bytes32 private constant IMPLEMENTATION_POSITION = keccak256("xinch.implementationPosition");
    bytes32 private constant PROPOSED_IMPLEMENTATION_POSITION = keccak256("xinch.proposedImplementationPosition");

    bytes32 private constant PROXY_ADMIN_POSITION = keccak256("xinch.proxyAdmin");
    bytes32 private constant PROXY_COSIGNER1_POSITION = keccak256("xinch.cosigner1");
    bytes32 private constant PROXY_COSIGNER2_POSITION = keccak256("xinch.cosigner2");

    bytes32 private constant PROPOSED_NEW_ADMIN  = keccak256("xinch.proposedNewAdmin");
    bytes32 private constant PROPOSED_NEW_ADMIN_TIMESTAMP  = keccak256("xinch.proposedNewAdminTimestamp");
